...
<# Skipping disable of automatic updates
write-verbose "Disable automatic download and installation of Windows updates"
...
#>
write-verbose "Disable seeding of updates to other computers via Group Policies"
...
#write-verbose "Disabling automatic driver update"
#sp "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching" "SearchOrderConfig" 0

<# Skipping hiding update notifications
write-verbose "Disable 'Updates are available' message"
